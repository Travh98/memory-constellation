extends Node
class_name NoteFrameTwoHandScaler


## Scales a NoteFrame's viewport display when grabbed with two hands.
## Grab points spread with scale up to max_grab_width.

@onready var _frame: NoteFrame = $".."
@onready var _viewport_node: Node3D = $"../Viewport2Din3D"
...
func apply_scale() -> void:
	...
	_viewport_node.scale = scale_vector
