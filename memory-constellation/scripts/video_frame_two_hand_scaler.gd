extends Node
class_name VideoFrameTwoHandScaler


## Scales a VideoFrame's display when grabbed with two hands.
## Grab points spread with scale up to max_grab_width.

@onready var _frame: VideoFrame = $".."
@onready var _screen: Node3D = $"../Screen"
